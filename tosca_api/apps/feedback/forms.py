...
class FeedbackLayerFormSet(BaseInlineFormSet):
    def clean(self):
        super().clean()
        if any(self.errors):
            return
        ...
        for form in self.forms:
            ...
            # If javascript failed or user entered manual duplicate:
            if display_order is not None and display_order in orders:
